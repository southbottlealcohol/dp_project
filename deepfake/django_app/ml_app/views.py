...
#Django에서 제공하는 render와 redirect 함수를 임포트합니다. 
# render는 템플릿과 데이터를 결합하여 HTML 텍스트를 생성하고, redirect는 다른 페이지로 리디렉션
import torch
import torchvision
from torchvision import transforms, models
#torchvision 라이브러리를 임포트하고, 그 안의 transforms와 models 모듈을 임포트합니다. 
#torchvision은 PyTorch의 도우미 라이브러리로, 컴퓨터 비전 연구에 유용한 도구들과 데이터셋을 제공
